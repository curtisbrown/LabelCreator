...
Item {
    ...
    Image {
        id: camera_box
        source: "images/images/camera_box.png"
        x: 18
        y: 18
        opacity: 1
    }
    Image {
        id: selection_bg
        source: "images/images/selection_bg.png"
        visible: false
        y: 197
        opacity: 1
    }
    Image {
        id: toggle_border
        source: "images/images/toggle_border.png"
        x: 5
        y: 153
        opacity: 1
    }
    Row {
        ...
        Button {
            ...
            style: ButtonStyle {
                ...
                label: Image {
                    ...
                    source: "images/images/camera_btn.png"
                }
            }
        ...
        Image {
            id: camera_selected
            source: "images/images/camera_selected.png"
            opacity: 1
            MouseArea {
                anchors.fill: parent
                onClicked: {
        ...
        Image {
            id: video_selected
            source: "images/images/video_selected.png"
            opacity: 1
            visible: false
            MouseArea {
                anchors.fill: parent
        ...
        Button {
            ...
            style: ButtonStyle {
                ...
                label: Image {
                    ...
                    verticalAlignment: Image.AlignVCenter
                    fillMode: Image.PreserveAspectFit
                    source: "images/images/video_btn.png"
                }
            }
            Keys.onReturnPressed: {
                videoBtnSelected()
        ...
        Button {
            ...
            style: ButtonStyle {
                ...
                label: Image {
                    ...
                    verticalAlignment: Image.AlignVCenter
                    fillMode: Image.PreserveAspectFit
                    source: "images/images/capture.png"
                }
            }
            Keys.onReturnPressed: {
                root.mouseClickCapture()
        ...
        Button {
            ...
            style: ButtonStyle {
                ...
                label: Image {
                    ...
                    verticalAlignment: Image.AlignVCenter
                    fillMode: Image.PreserveAspectFit
                    source: "images/images/record.png"
                }
            }
            Keys.onReturnPressed: {
                root.videoRecordBegin()
        ...
        Button {
            ...
            style: ButtonStyle {
                ...
                label: Image {
                    ...
                    verticalAlignment: Image.AlignVCenter
                    fillMode: Image.PreserveAspectFit
                    source: "images/images/record_stop.png"
                }
            }
            Keys.onReturnPressed: {
                root.videoSaveVideo()
