...
Item {
    ...
    Timer {
        ...
        interval: 500
        onTriggered: {
            console.log("getWbRGBValuesTimer")
    ...
    Connections
    {
        ...
        onGetVideoPinStatus:
        {
            console.log("ENABLE VID PINS");
            root.enableVideoPin(true);
        }
        onGetStillImageFormats:
        {
            console.log("INSERTING VID FORMAT");
        ...
        ColumnLayout{
            ...
            GridLayout {
                ...
                Slider {
                    ...
                    Component.onCompleted: {
                        console.log("SKIP UPDATING GAIN VALSs");
                        skipUpdateGainValues = true
                    }
                }
    ...
    See3Cam81 {
        ...
        onUpdateFrameToSkipfromCam81:{
            console.log("FRAME TO SKIP");
            root.updateFrametoSkip(stillSkip)
        }
        onReturnFromSetFocusMode:{
            console.log("RETURN FROM SET FOCUS");
    ...
    function setDefaultValues(){
        console.log("SETTING DEFAULT CAM VALS");
