    ...
    Button {
        ...
        style: ButtonStyle {
            ...
            label: Image {
                ...
                source: "images/images/videocapturesettings.png"
            }
        }
        ScrollView {
                ...
                GridLayout {
                    ...
                    ComboBox {
                        ...
                        style: ComboBoxStyle {
                            background: Image {
                                id: frameRateBox
                                source: "images/images/device_box.png"
                                Rectangle {
                        ...
                        Button {
                            ...
                            style: ButtonStyle {
                                background: Image {
                                    ...
                                    fillMode: Image.PreserveAspectFit
                                    source: "images/images/still_box.png"
                                    Rectangle {
                            ...
                            Image {
                                id: open_folderVideo
                                source: "images/images/open_folder.png"
                                x: 205
                                y: 6
                                opacity: 1
                            }
