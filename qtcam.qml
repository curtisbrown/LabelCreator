...
Rectangle {
    id: root
    property alias widthRoot: root.width
    property alias heightRoot: root.height
    ...
    Image {
        id: layer_0
        source: "qrc:/images/images/layer_0.png"
    ...
    ScrollView {
        ...
        height: vidstreamproperty.height < layer_0.height ? vidstreamproperty.height : parent.height
        style: ScrollViewStyle {
            scrollToClickedPosition: true
            scrollBarBackground: Image {
                source: styleData.horizontal? "qrc:/images/images/Horizontal_Scroll_base.png" : "qrc:/images/images/Vertical_Scroll_base.png"
            }
            incrementControl: Image {
                source: styleData.horizontal? "qrc:/images/images/Horizontal_right_arrow.png" : "qrc:/images/images/Vertical_down_arrow.png"
            }
            decrementControl: Image {
                source: styleData.horizontal? "qrc:/images/images/Horizontal_left_arrow.png" : "qrc:/images/images/Vertical_top_arrow.png"
            }
        }
        Videostreaming {
...
//            }
    ...
    Image {
        id: open_sideBar
        visible: false
        source: "qrc:/images/images/open_tab.png"
    ...
    Item {
        ...
        Image {
            id: side_bar_bg
            source: "qrc:/images/images/side_bar_bg.png"
            x: -3
            y: -3
        ...
        ComboBox {
            ...
            style: ComboBoxStyle {
                background: Image {
                    id: deviceBox
                    source: "qrc:/images/images/device_box.png"
                    Rectangle {
            ...
            onCurrentIndexChanged: {
                if(currentIndex.toString() != "-1" && currentIndex.toString() != "0") {                    
                    if(oldIndex!=currentIndex) {
                        ...
                        updateFPS("YUYV (YUYV 4:2:2)", "640x480")
                        console.log("<<<<<<< line 557")
                        vidstreamproperty.startAgain()                        
                        vidstreamproperty.width = /*stillSettingsRootObject.stillOutputTextValue.split("x")[0].toString()*/ "640"
                        vidstreamproperty.height = /*stillSettingsRootObject.stillOutputTextValue.split("x")[1].toString()*/ "480"
                        vidstreamproperty.lastPreviewResolution(/*stillSettingsRootObject.stillOutputTextValue,stillSettingsRootObject.stillColorComboIndexValue*/"640x480", "0")
...
//                        JS.videocaptureFps = videoSettingsRootObject.videoFrameRate
        ...
        Button {
            ...
            style: ButtonStyle {
                background: Image {
                    source: (!cameraColumnLayout.visible || control.activeFocus) ? "qrc:/images/images/toggle_selection.png" : ""
                }
                label: Text {
        ...
        Component {
            ...
            SliderStyle {
                ...
                handle: Image {
                    source: "qrc:/images/images/handle.png"
                    opacity: 1
                }
            }
        }
        ...
        Component {
            ...
            ButtonStyle {
                background: Image {
                    source: cameraColumnLayout.visible ? "qrc:/images/images/toggle_selection.png" : ""
                }
                label: Text {
                    horizontalAlignment: Image.AlignHCenter
                    verticalAlignment: Image.AlignVCenter
        ...
        Image {
            id: close_sideBar
            source: "qrc:/images/images/close_tab.png"
    ...
    function createExtensionUnitQml(selectedDeviceEnumValue){
        ...
        if(selectedDeviceEnumValue === CommonEnums.SEE3CAM_81) {
            console.log(">>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>")
    ...
    function openHIDDevice(selectedEnum)
    {
        switch(selectedEnum)
        {
			case CommonEnums.SEE3CAM_81:
                console.log(device_box.currentText)
    ...
    Component.onCompleted: {
        ...
        {
            see3cam = Qt.createComponent("qrc:/others.qml").createObject(root)
            see3cam.visible = false
            extensionTabVisible(false)
        }
        ...
        {
            aboutViewRootObject = aboutViewComponent.createObject(root,{});
        }
